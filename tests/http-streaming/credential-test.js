  ...
  try {
    ...
    try {
      ...
      if (error.name === 'AbortError') {
        console.log(
          'Credential schema request timed out - this is expected if no n8n instance is available'
        );
      } else {
    ...
    try {
      ...
      if (error.name === 'AbortError') {
        console.log(
          'Create credential request timed out - this is expected if no n8n instance is available'
        );
      } else {
