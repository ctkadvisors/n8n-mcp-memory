...
import type { variableList } from '../models/variableList.js';
...
export class VariablesService {
   ...
   * @throws ApiError
   */
  public static postVariables(requestBody: variable): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public static deleteVariables(id: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/variables/{id}',
      path: {
