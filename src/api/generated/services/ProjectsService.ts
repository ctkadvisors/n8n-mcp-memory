...
import type { projectList } from '../models/projectList.js';
...
export class ProjectsService {
   ...
   * @throws ApiError
   */
  public static postProjects(requestBody: project): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public static getProjects(limit: number = 100, cursor?: string): CancelablePromise<projectList> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/projects',
      query: {
   ...
   * @throws ApiError
   */
  public static deleteProjects(projectId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
