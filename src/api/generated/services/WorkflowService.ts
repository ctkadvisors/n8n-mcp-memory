...
/* tslint:disable */
/* eslint-disable */
import type { tagIds } from '../models/tagIds.js';
import type { workflow } from '../models/workflow.js';
import type { workflowList } from '../models/workflowList.js';
import type { workflowTags } from '../models/workflowTags.js';
...
export class WorkflowService {
   ...
   * @throws ApiError
   */
  public static postWorkflows(requestBody: workflow): CancelablePromise<workflow> {
   ...
   * @throws ApiError
   */
  public static deleteWorkflows(id: string): CancelablePromise<workflow> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/workflows/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static putWorkflows(id: string, requestBody: workflow): CancelablePromise<workflow> {
    return __request(OpenAPI, {
      method: 'PUT',
      url: '/workflows/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static postWorkflowsActivate(id: string): CancelablePromise<workflow> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static postWorkflowsDeactivate(id: string): CancelablePromise<workflow> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static getWorkflowsTags(id: string): CancelablePromise<workflowTags> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static putWorkflowsTags(id: string, requestBody: tagIds): CancelablePromise<workflowTags> {
    return __request(OpenAPI, {
      method: 'PUT',
      url: '/workflows/{id}/tags',
      path: {
